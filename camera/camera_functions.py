...
def capture(img_save_path, save_file_name='image' ,AUTO_SAVE_INTERVAL=2.0, MAX_SAVE_FRAMES = 1, SAVE_CONFIG = 1, post_process = 1):
    # 配置管道 (Pipeline)
    ...
    try:
        ...
        while True:
            ...
            if post_process == 1:
                #depth_frame = decimation.process(depth_frame)      # 1. 降采样
            ...
            if current_time - last_save_time >= AUTO_SAVE_INTERVAL:
                ...
                #with open(os.path.join(img_save_path, "capturing_timestamp.txt"), "w") as f:
                #        f.write(timestamp)
...
if __name__ == "__main__":
    capture('/home/smmg/AAM/perception/result/1st_capturing/','test',2,1,0,1)